    ...
    <div className="panel flex flex-col gap-2.5 p-3 sm:flex-row sm:flex-wrap sm:items-center sm:gap-3 sm:p-4">
      <div className="relative flex-1">
        ...
        <input
          ...
          className="h-10 w-full rounded-md border border-white/10 bg-ink-800 pl-9 pr-9 text-sm text-white placeholder:text-grey-500 outline-none transition-colors duration-fast focus:border-leaf-500/60"
        />
        {value.q && (
          <button
            type="button"
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 text-grey-500 hover:text-white"
          >
      ...
      <div className="flex gap-1.5 rounded-pill border border-white/10 bg-ink-800 p-1">
        {(
          [
      ...
      <select
        ...
        className="h-10 rounded-md border border-white/10 bg-ink-800 px-3 text-sm text-white outline-none transition-colors duration-fast focus:border-leaf-500/60 sm:w-40"
      >
      ...
      {hasActiveFilters && (
        <button
          ...
          className="text-xs font-semibold text-grey-500 underline-offset-2 hover:text-white hover:underline"
        >
          {t("filters.clear")}
        </button>
      )}
